...
namespace EGManageTopicsAndEventSubscriptions
{
    ...
    public class Program
    {
        ...
        static readonly string TopicName = "deadletter-topicsample" + Guid.NewGuid().ToString().Substring(0, 8);
        ...
        const string EventSubscriptionName = "EventSubscriptionWithDeadLetter";
